...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'driverslicense_img' => 'required|string', //required|image|max:2048',
            'driverslicense_img2' => 'required|string', //required|image|max:2048',
        ...
        if($validator->fails()){
            ...
            $customer = Customer::create([
                ...
                'driverslicense_img' => $request->driverslicense_img,
                'driverslicense_img2' => $request->driverslicense_img2,
